...
export default async function AdminTripsPage() {
  ...
  return <AdminShell><section className="admin-section"><div className="admin-page-heading"><div><span className="section-label">Contenido</span><h1>Viajes</h1></div></div>
