  ...
  return <div className="admin-shell">
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar" aria-label="Navegacion del panel">
        ...
        {tripSlug && <><Link href={base}>Resumen</Link><Link href={`${base}/medios`}>Medios</Link><Link href={`${base}/dias`}>Dias</Link><Link href={`${base}/lugares`}>Lugares</Link><Link href={`${base}/portadas`}>Portadas</Link></>}
      </aside>
